...
export const aiConfigSchema = z.object({
  ...
  googleFlowBrowser: z.object({
    ...
    loginUrlPath: z.string().default('/v1/auth/login-url'),
    sessionStatusPath: z.string().default('/v1/auth/session-status'),
    reloginPath: z.string().default('/v1/auth/relogin'),
    profilesPath: z.string().default('/v1/profiles'),
    profileByIdPath: z.string().default('/v1/profiles/{profileId}'),
